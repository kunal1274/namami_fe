...
function ItemList({ handleAddItem }) {
  ...
  return (
    <div className="bg-grey-400 p-2 min-h-screen">
                ...
                <table className="w-full text-sm text-gray-700 border-collapse">
                  <thead className="bg-gray-200 sticky top-0 z-10">
                    <tr className="text-left text-gray-800 font-semibold uppercase">
                      ...
                      <th className="px-6 py-3 border border-gray-300 whitespace-nowrap">
                        Item Name
                      </th>
                      <th className="px-4 py-3 border border-gray-300 text-center">
                        Type
                      </th>
                      <th className="px-8 py-6 border border-gray-300 whitespace-nowrap">
                        Description
                      </th>
                      <th className="px-4 py-3 border border-gray-300 text-center">
                        Unit
