...
export const EstimationModal = ({ isOpen, onClose, estimation }) => {
...
export default function RideBookingLanding() {
  ...
  // for Drawer
  const [showDrawer, setShowDrawer] = useState(false); // <--- NEW
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="relative bg-gray-200 h-48 sm:h-64 md:h-72 lg:h-80">
        ...
        <div className="relative z-10 flex items-center px-4 py-3">
          ...
          <button
            className="p-1 rounded-full bg-white shadow mr-2"
            onClick={() => setShowDrawer(true)} // Toggle the drawer
          >
