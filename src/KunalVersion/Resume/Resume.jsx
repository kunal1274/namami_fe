...
// Sample color palette used:
// Left column background: bg-gray-800
// Left column text: text-white
// Right column background: bg-white
// Right column text: text-gray-900
// Feel free to customize these classes to match your desired style.

export const ResumeContent = React.forwardRef((props, ref) => {
  return (
    <div ref={ref} className="min-h-screen md:flex font-sans">
      {/** LEFT COLUMN **/}
      ...
      <main className="md:w-2/3 bg-white text-gray-900 p-6">
        ...
        <section className="mb-8">
          ...
          <p>
            Enthusiastic, 14.3+ years experienced D365 F&O (AX) consultant with
            deep functional expertise across Financials, Trade & Logistics,
            Project Mgmt. & Accounting, and Service Mgmt. Skilled in delivering
            end-to-end implementations (24+ full cycle) and managing global
            teams. Recognized for driving client success, complex integrations,
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-6 space-y-1">
            ...
            <li>Client Satisfaction: 7/7 CSAT from multiple implementations</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-6 mt-2 space-y-1">
              ...
              <li className="mt-2">
                <strong>Multi-Location Client (23)</strong> &lt;AI & Copilot&gt;
                (Mar ’24 – Jul ’24)
              </li>
              <li>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-6 mt-2 space-y-1">
              ...
              <li className="mt-2">
                <strong>Commodity Trading & Risk Mgmt. (18,19)</strong> (Dec ’19
                – Feb ’21)
              </li>
              <li>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-6 mt-2 space-y-1">
              <li>
                Multiple onsite US implementations (Agriculture, Gov Port, etc.)
              </li>
          ...
          {/* Wipro */}
          <div className="mb-6">
            <h3 className="font-bold">Wipro Infotech Pvt. Ltd. (India/UAE)</h3>
            <p className="italic text-sm">
            ...
            <ul className="list-disc ml-6 mt-2 space-y-1">
              ...
              <li>Recognized for meeting tight deadlines & cost reductions</li>
            </ul>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="mb-4">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>Demonstrated cross-functional leadership in global teams</li>
            </ul>
          </div>
...
function Resume() {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: "Kunal_Resume", // Name of the PDF
    pageStyle: `
      @page {
        size: A4;
        margin: 12mm;
  ...
  return (
    <div>
      ...
      {/* Render the resume content but hide it if you like */}
      <div className="mt-8">
